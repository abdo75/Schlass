...
// RefreshStore: opaque 32-byte tokens stored under sha256 hash. Every
// rotation in a family shares family_id; reuse of an already-used token
// triggers RevokeFamily per OAuth 2.1 §4.13.
...
// MarkUsed is idempotent — expired/missing/already-used all return nil.
