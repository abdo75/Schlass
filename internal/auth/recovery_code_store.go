// Package mfa handles TOTP enrollment, challenge verification, and recovery
// code management. Transient enrollment/challenge state lives in Valkey;
// committed state (encrypted secret, recovery hashes) is written to PG.
package auth
